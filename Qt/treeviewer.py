...
class Ui_TreeView(object):
    def setupUi(self, TreeView):
        ...
        self.gridLayout.addWidget(self.IconView, 2, 1, 1, 1)
        self.ObjectView = QtWidgets.QTableView(self.tabObjectView)
        self.ObjectView.setObjectName("ObjectView")
        self.gridLayout.addWidget(self.ObjectView, 0, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self.ImageView, 0, 1, 2, 1)
        ...
        self.TreeViewer.header().setVisible(False)
