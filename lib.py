...
#               attrname,   type,       hook,            version,    None
    ...
    lambda v:  ('maintain', 'uint16',   lambda x: x/100) if v > 1    else None,
...
#               attrname,   type,       hook,            version,    None
    ...
    lambda v:  ('ex_data',  'uint32',   lambda x: x)     if v > 0    else None,
    lambda v:  ('size_x',   'uint16',   lambda x: x)     if v > 0    else None,
    lambda v:  ('size_y',   'uint16',   lambda x: x)     if v > 0    else None,
